...
def crawl_question_html_task():
    ...
    # """)
    sql = text("""
    SELECT DISTINCT illness_question_id FROM raw_html_illness WHERE illness_type LIKE '疤痕疙瘩' OR illness_type LIKE '口腔溃疡' OR illness_type LIKE '龋齿' OR illness_type LIKE '睡眠障碍' OR illness_type LIKE '散光' OR illness_type LIKE '近视眼' OR illness_type LIKE '焦虑症'
    """)
